...
let ProductResolver = class ProductResolver {
    updateProduct({ em }, idNote, key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            const note = yield em.findOne(Note, { idNote: idNote });
            if (!note)
                return;
            note.key = key;
            note.value = value;
    ...
    deleteProduct({ em }, idNote) {
        return __awaiter(this, void 0, void 0, function* () {
            const note = yield em.findOne(Note, { idNote: idNote }, ['contact']);
            if (!note)
                return false;
    ...
    createNote({ em }, id, key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            const contact = yield em.findOne(Contact, { id: id });
            if (!contact)
                return null;
...
__decorate([
    ...
    __param(2, (0, type_graphql_1.Arg)('key')),
...
__decorate([
    ...
    __param(0, (0, type_graphql_1.Ctx)()),
    __param(1, (0, type_graphql_1.Arg)('idNote')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Number, String, String]),
    __metadata("design:returntype", Promise)
], ProductResolver.prototype, "createNote", null);
